...
const dicts: Record<Lang, Dict> = {
  en: {
    ...
    about_body: "Based in Kénitra, Morocco. I work on projects where the business logic gets complex: ERPs for religious-travel agencies, real-time marketplaces for gaming currency, multi-portal school systems. I handle both ends of the problem — large-scale data collection and clean, usable admin interfaces.",
...
about_body: "Basé à Kénitra, Maroc. J'interviens sur des projets où la logique métier devient complexe : ERP pour agences de voyage religieux, marketplaces temps réel de monnaie virtuelle, systèmes scolaires multi-portails. Je prends en charge les deux bouts du problème — la collecte de données à grande échelle et des interfaces d'administration claires et fonctionnelles.",
...
about_body: "Con base en Kénitra, Marruecos. Trabajo en proyectos donde la lógica de negocio se vuelve compleja: ERPs para agencias de viajes religiosos, mercados en tiempo real de moneda virtual, sistemas escolares multi-portal. Me encargo de ambos extremos del problema — la recolección de datos a gran escala y paneles de administración claros y funcionales.",
...
about_body: "أعمل من مدينة القنيطرة بالمغرب. أتخصص في المشاريع ذات المنطق البرمجي المعقد: أنظمة ERP لوكالات السفر الديني، أسواق عملات الألعاب في الوقت الحقيقي، وأنظمة مدرسية متعددة البوابات. أتكفل بجانبي المشكلة معاً — جمع البيانات على نطاق واسع، وواجهات إدارة واضحة وسهلة الاستخدام.",
