...
const dicts: Record<Lang, Dict> = {
  en: {
    ...
    contact_lead:
      "Best for: full-stack builds, scraping pipelines, AI-agent workflows, ERP rescues.",
    contact_email: "Email",
    ...
    p_masterfut_desc:
      "International marketplace for virtual gaming currency. Real-time stock, ten languages, Stripe + PayPal + crypto rails.",
    p_ka3ba_tag: "Hajj & Omra ERP",
    p_ka3ba_desc:
      "Quotes, accounting, suppliers, programs, plus an LLM assistant that drafts controllers and PDF quotes from a chat box.",
    p_almoulate_tag: "Real-estate ops",
    p_almoulate_desc:
      "All-in-one platform: financial transactions, construction projects, full HR module, analytics on top.",
    p_aligarage_tag: "Garage SaaS",
    p_aligarage_desc:
      "Stock, service history, POS, and profit tracking for a private garage network.",
    p_smile_tag: "B2B distribution",
    p_smile_desc:
      "Professional cleaning-products distribution with a client quotation engine and CMS-driven catalog.",
    p_school_tag: "School platform",
    p_school_desc:
      "Four portals — admin, teacher, parent, student — with attendance, LMS integration, and fee management over REST.",
    ...
    p_shorts_desc:
      "Autonomous Python bot on GitHub Actions — extracts, edits, and publishes three Shorts per day.",
  ...
  fr: {
    ...
    contact_lead:
      "Pour : développements full-stack, pipelines de scraping, agents IA, sauvetages d'ERP.",
    ...
    p_masterfut_desc:
      "Marketplace internationale de monnaie virtuelle. Stock temps réel, dix langues, Stripe + PayPal + crypto.",
    p_ka3ba_tag: "ERP Hajj & Omra",
    p_ka3ba_desc:
      "Devis, comptabilité, fournisseurs, programmes, plus un assistant LLM qui rédige des contrôleurs et des devis PDF depuis un chat.",
    p_almoulate_tag: "Gestion immobilière",
    p_almoulate_desc:
      "Plateforme tout-en-un : transactions financières, projets de construction, module RH complet, analytics.",
    p_aligarage_tag: "SaaS garage",
    p_aligarage_desc:
      "Stock, historique service, POS et suivi de marge pour un réseau de garages privé.",
    p_smile_tag: "Distribution B2B",
    p_smile_desc:
      "Distribution de produits de nettoyage professionnels avec moteur de devis et catalogue CMS.",
    p_school_tag: "Plateforme scolaire",
    p_school_desc:
      "Quatre portails — admin, enseignant, parent, élève — avec présence, intégration LMS et gestion des frais via REST.",
    p_codev_tag: "EdTech · IA",
    p_codev_desc:
      "Plateforme EdTech multilingue (AR/FR/EN) avec outils d'analyse de code propulsés par IA.",
    ...
    p_shorts_desc:
      "Bot Python autonome sur GitHub Actions — extrait, monte et publie trois Shorts par jour.",
  ...
  es: {
    ...
    contact_lead:
      "Ideal para: desarrollos full-stack, pipelines de scraping, agentes de IA, rescate de ERPs.",
    ...
    p_masterfut_desc:
      "Mercado internacional de moneda virtual. Stock en tiempo real, diez idiomas, Stripe + PayPal + cripto.",
    p_ka3ba_tag: "ERP Hajj y Omra",
    p_ka3ba_desc:
      "Presupuestos, contabilidad, proveedores, programas y un asistente LLM que redacta controladores y PDFs desde un chat.",
    p_almoulate_tag: "Gestión inmobiliaria",
    p_almoulate_desc:
      "Plataforma todo-en-uno: transacciones, proyectos de construcción, módulo RH completo, analítica.",
    p_aligarage_tag: "SaaS de taller",
    p_aligarage_desc:
      "Stock, historial de servicios, TPV y seguimiento de margen para una red privada de talleres.",
    p_smile_tag: "Distribución B2B",
    p_smile_desc:
      "Distribución de productos de limpieza profesional con motor de cotizaciones y catálogo CMS.",
    p_school_tag: "Plataforma escolar",
    p_school_desc:
      "Cuatro portales — admin, profesor, padre, alumno — con asistencia, integración LMS y gestión de pagos vía REST.",
    p_codev_tag: "EdTech · IA",
    p_codev_desc:
      "Plataforma EdTech multilingüe (AR/FR/EN) con análisis de código asistido por IA.",
    ...
    p_shorts_desc:
      "Bot Python autónomo en GitHub Actions — extrae, edita y publica tres Shorts al día.",
  ...
  ar: {
    ...
    p_masterfut_desc:
      "سوق دولي لبيع عملات الألعاب. مخزون في الوقت الحقيقي، 10 لغات، وربط مع Stripe و PayPal و Crypto.",
    p_ka3ba_tag: "ERP للحج والعمرة",
    p_ka3ba_desc:
      "نظام شامل للمحاسبة والموردين، مع مساعد ذكاء اصطناعي يقوم بكتابة الأكواد وعروض الأسعار من خلال الدردشة.",
    p_almoulate_tag: "إدارة العقارات",
    p_almoulate_desc:
      "منصة متكاملة: معاملات مالية، تتبع مشاريع البناء، وحدة موارد بشرية كاملة، وتحليلات البيانات.",
    ...
    p_school_desc:
      "أربع بوابات (إدارة، أستاذ، أب، طالب) مع تتبع الحضور وإدارة الرسوم عبر REST API.",
    ...
    p_shorts_desc:
      "بوت Python يعمل عبر GitHub Actions — يقوم باستخراج وتحرير ونشر 3 فيديوهات قصيرة يومياً تلقائياً.",
