...
export const projects: Project[] = [
  {
    ...
    stack: ["Laravel", "React", "MySQL", "Stripe", "PayPal"],
    year: "2024",
  },
  {
    id: "ka3ba",
    ...
    url: "https://ka3ba.com",
    stack: ["Next.js", "Laravel", "MySQL", "LLM"],
    year: "2024",
  },
  {
    id: "almoulate",
  ...
  },
  {
    ...
    stack: ["Vue.js", "Laravel", "SQL Server"],
    year: "2023",
  },
  {
    id: "smile",
...
export type StackGroup = {
  titleKey: string;
  items: { name: string; level?: string; learning?: boolean }[];
};
